...
id = "3100584981"
dr = dbh.query("select * from addfollow where f='#{id}' and retcode='100000' order by updated_at asc")
dr.each_hash{|r|
     next if !r
   ...
   # if u&& u["code"].to_i == 100001 && u["msg"].unpack("U*").pack("U*").start_with?("抱歉，TA还不是你关注的人".unpack("U*").pack("U*"))
